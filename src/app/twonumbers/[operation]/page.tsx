...
function TwoNumbersPage() {
    ...
    const [mascotEmotion, setMascotEmotion] = useState<'happy' | 'sad' | 'excited' | 'thinking'>('happy'); // imagen del la imagen del avatar
    ...
    const getGameTitle = () => {
        switch (operation) {
            case 'addition': return 'Sumas Divertidas';
            case 'subtraction': return 'Restas Mágicas';
            default: return 'Juego Matemático';
        }
    };
            ...
            <div className="w-full max-w-4xl">
                ...
                <div className="bg-white rounded-2xl p-6 mb-8 shadow-lg flex items-center justify-between">
                    <div className="flex items-center">
                        ...
                        <div className="ml-4">
                            <h2 className="text-2xl font-bold text-indigo-700">{getGameTitle()}</h2>
                ...
                <div className="bg-white rounded-2xl p-8 shadow-lg mb-8">
                    <div className="flex justify-center items-center mb-8">
                        <div className="text-6xl font-bold text-center flex items-center justify-center">
                            <span className="bg-blue-100 text-blue-700 rounded-lg p-4 w-24 h-24 flex items-center justify-center">{num1}</span>
                            <span className="mx-4 text-gray-700">{getOperationSymbol()}</span>
                            <span className="bg-green-100 text-green-700 rounded-lg p-4 w-24 h-24 flex items-center justify-center">{num2}</span>
                            <span className="mx-4 text-gray-700">=</span>
                            <span className="bg-purple-100 text-purple-700 rounded-lg p-4 w-24 h-24 flex items-center justify-center">?</span>
                        </div>
                    </div>
